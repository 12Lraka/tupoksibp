...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark"><small>Detail Pembimbingan Dewasa</small></h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{route('dashboard.index')}}">Dashboard</a></li>
                <li class="breadcrumb-item active">DPDewasa</li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <strong><i class="fas fa-id-card mr-1"></i> Nama Klien</strong>
                <p class="text-muted">
                {{$dbimbingan->nama_klien}}
                </p>
                <hr>

                <strong><i class="far fa-id-badge mr-1"></i> Nama Petugas</strong>
                <p class="text-muted">{{$dbimbingan->nama_petugas}}</p>     
                <hr>

                <strong><i class="fas fa-book mr-1"></i> Total Pembimbingan</strong>
                <p class="text-muted">
                {{$dbimbingan->rincian->count()}}
                </p>
                <hr>
              </div>
          ...
          <div class="col-md-9">
            ...
            <div class="card-body">
              <table class="table table-bordered table-striped table-hover">
                  ...
                  <tbody>
                    @foreach($dbimbingan->rincian as $rincian)
                    <tr>
...
<div class="modal fade create" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="POST" action="/dbimbingan/{{$dbimbingan->id}}/adddetail" enctype="multipart/form-data">
              @csrf
